...
trait Tables {
  ...
  case class TopicsRow(id: String, title: String, description: Option[String] = None, score: Short, createdAt: java.sql.Timestamp)
  /** GetResult implicit for fetching TopicsRow objects using plain SQL queries */
  implicit def GetResultTopicsRow(implicit e0: GR[String], e1: GR[Option[String]], e2: GR[Short], e3: GR[java.sql.Timestamp]): GR[TopicsRow] = GR{
    prs => import prs._
